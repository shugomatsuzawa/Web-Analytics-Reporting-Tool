...
?>
<?php
function organicUsersChart($reports) {
    ...
    <section class="mainChart">
        <canvas id="organicUsersChart"></canvas>
        <script>
        var ctx = document.getElementById("organicUsersChart");
...
organicUsersChart($usersChartResponse);
?>
<?php
$keywordMetrics = array($users, $newUsers, $sessions, $bounceRate, $pageviewsPerSession, $avgSessionDuration, $goalConversionRate, $goalCompletions, $goalValue);
$keywordDimensions = array($keyword);
$keywordOrder = 'ga:users';
$keywordResponse = getReport($analytics, $viewId, $startDate, $endDate, $keywordMetrics, $keywordDimensions, $keywordOrder);

function keywordResults($reports) {
    ...
    <table>
        ...
        <thead>
            <tr>
                <th colspan="2" rowspan="2">キーワード</th>
                <th colspan="3">集客</th>
                <th colspan="3">行動</th>
